...
//If current's data is greater than index's data, swap the data of current and index  
	           if(current.s.getActivityLevel() < index.s.getActivityLevel()) {  
	                temp = current.s;  
	                current.s = index.s;  
	                index.s = temp;  
	            }  
	...
	//If current's data is greater than index's data, swap the data of current and index  
	 ...
	 public void sortClassification() {
			Node current = null, index = null;  
		    Student temp;  
		        //Check whether list is empty  
		    if(head == null) {  
		    ...
		    //Current will point to head  
		     for(current = head; current.next != null; current = current.next) {  
		       //Index will point to node next to current  
		        for(index = current.next; index != null; index = index.next) {  
	//If current's data is greater than index's data, swap the data of current and index  
		           if(current.s.getClassification().compareTo(index.s.getClassification()) == 1) {  
		                temp = current.s;  
		                current.s = index.s;  
		                index.s = temp;  
		            }  
		    ...
		    //Current will point to head  
		     for(current = head; current.next != null; current = current.next) {  
		       //Index will point to node next to current  
		        for(index = current.next; index != null; index = index.next) {  
	//If current's data is greater than index's data, swap the data of current and index  
		           if(current.s.getName().compareTo(index.s.getName()) == 1) {  
		                temp = current.s;  
		                current.s = index.s;  
		                index.s = temp;  
		            }  
